...
> Note: this is the archived original English README. The active (Chinese) guide lives in [README.md](README.md), and the repository has been reorganized (`papillarray/` package + `scripts/` entry points, uv + Python 3.12). The mapping from the original file names to the new locations is documented in README.md.
